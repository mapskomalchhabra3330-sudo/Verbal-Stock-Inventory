...
const prompt = ai.definePrompt({
  ...
  - EDIT_ITEM: To modify an existing item. Requires the itemName.
  ...
  If a command is to "edit", "update", or "change" an item, it's EDIT_ITEM.
  ...
  When editing, viewing, or deleting an item, you MUST extract the itemName.
